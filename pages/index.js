...
import styless , {keyframe} from "./../styles/home4.module.css"
...
const Home3 = () =>{
    return( <>
        ...
        <section className={styless.home22 }><div className={styless.shape } >
...
<div className={styless.homeleft}>
  <p className={styless.stitle }>Welcome To One line </p>
 ...
 {/* <Typical
        ...
        wrapper="p"
      /> */}
    <span className={styless.underlineimg}>Instructor <span> <Image src={bannerline} alt="line"  width="302px  "/></span></span>
  </h1>
...
<div className={styless.homeright}>
  ...
  {/* <Image src={bannerimgbg} alt="colorful background shape" className={styless.backgroundshape}/> */}
    <Image src={bannerimg} alt="banner image" className={styless.bannerimg} height="657" width="395"/>
